    ...
    <div class="container">
        ...
        <div class="legal-content">
            ...
            <div class="legal-section">
                ...
                <p>
                    Компания предоставляет доступ к сайту <strong><?= $fullDomain ?></strong> и его инновационным материалам, включая AI-инструменты и экспертные консультации.
                </p>
            </div>

            <div class="legal-section">
                <h2>2. Правила платформы</h2>
                <p>При использовании <strong><?= $domainTitle ?></strong> запрещается:</p>
                <ul class="legal-list">
                    <li>Действия, нарушающие работу цифровой инфраструктуры.</li>
                    <li>Использование автоматизированных скриптов для сбора данных.</li>
            ...
            <div class="legal-section">
                ...
                <div class="property-block">
                    ...
                    <p>
                        Весь контент на <strong><?= $fullDomain ?></strong> является собственностью Компании. Вам предоставляется ограниченная лицензия для личного использования. Копирование запрещено.
                    </p>
                </div>
            </div>
            ...
            <div class="legal-section">
                ...
                <div class="warning-block">
                    <p>
                        Услуги предоставляются по принципу <strong>«как есть»</strong>. Мы не несем ответственности за любые убытки, возникшие в результате использования платформы.
                    </p>
                </div>
            </div>
