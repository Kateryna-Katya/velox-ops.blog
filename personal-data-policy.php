        ...
        <div class="container">
            ...
            <div class="legal-content">
                <div class="policy-intro">
                    ...
                    <p>
                        Настоящая политика обработки персональных данных (далее — «Политика») определяет порядок и условия обработки данных платформой <strong><?= $domainTitle ?></strong>.
                    </p>
                    <p>
                        1.1. Важнейшей целью Оператора является защита прав на неприкосновенность частной жизни, личную и семейную тайну.
                    </p>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <ul class="terminology-list">
                        <li><strong>Веб-сайт</strong> — ресурс <strong><?= $fullDomain ?></strong>.</li>
                    ...
                    <div class="data-grid">
                        ...
                        <div class="data-item">
                            ...
                            <div>
                                ...
                                <span>Cookies, IP-адрес, браузер.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Установление обратной связи и заявок.</li>
                ...
                <div class="policy-section contact-footer-policy">
                    ...
                    <p>Свяжитесь с нами для уточнения деталей:</p>
